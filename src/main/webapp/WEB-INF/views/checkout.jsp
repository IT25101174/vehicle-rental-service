...
<head>
    ...
    <title>Secured Checkout — Intelligent Auto Rentals</title>
...
<body>
    ...
    <main class="container">
        ...
        <div class="summary-panel">
            ...
            <h2 class="panel-title" style="font-size: 1.4rem; margin-bottom: 1.2rem;"><%= vehicle.getBrand() %> <span><%= vehicle.getType() %></span></h2>
