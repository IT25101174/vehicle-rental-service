...
<head>
    ...
    <title>Vehicle Categories — Intelligent Auto Rentals</title>
                ...
                <tbody>
                    ...
                    %>
                        <tr>
                            ...
                            <td class="td-name"><%= c.getName() %></td>
                            <td class="td-desc"><%= c.getDescription() %></td>
                            <td>
                                <div class="action-btns" style="justify-content: flex-end;">
                                    <a href="category?action=editForm&id=<%= c.getId() %>" class="btn-edit">Edit</a>
                                    <a href="category?action=delete&id=<%= c.getId() %>" class="btn-del" onclick="return confirm('Are you sure you want to delete the category \'<%= c.getName() %>\'? Vehicles of this classification will lose their grouping.');">Delete</a>
                                </div>
                            </td>
                        </tr>
                    <% 
