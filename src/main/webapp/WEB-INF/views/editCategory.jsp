...
<head>
    ...
    <title>Edit Category — Intelligent Auto Rentals</title>
...
<div class="container">
    <div class="card">
        <div class="card-header">
            <span class="card-tag">Edit Configuration</span>
            <h2 class="card-title">Modify Category</h2>
        </div>
        ...
        <form action="category?action=update" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" required value="<%= c.getName() %>">
            </div>

            <div class="form-group">
                <label for="desc">Description</label>
                <textarea id="desc" name="desc" required><%= c.getDescription() %></textarea>
            </div>
