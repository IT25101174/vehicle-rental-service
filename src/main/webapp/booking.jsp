...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .nav-right a { font-size: 0.82rem; color: var(--muted); text-decoration: none; transition: color 0.2s; }
        ...
        .status-active   { background: var(--green-dim); color: var(--green); border: 1px solid rgba(74,222,128,0.2); }
        .status-cancelled{ background: var(--danger-dim); color: var(--danger); border: 1px solid rgba(248,113,113,0.2); }
        .status-default  { background: rgba(240,165,0,0.1); color: var(--gold); border: 1px solid rgba(240,165,0,0.2); }
...
<div class="container">
    <div class="page-header">
        ...
        <a href="vehicle?action=list" class="btn-new">+ New Booking</a>
    </div>
    ...
    <div class="empty-state">
        ...
        <a href="vehicle?action=list" class="btn-new">Book a Vehicle</a>
    </div>
    <% } %>
</div>
