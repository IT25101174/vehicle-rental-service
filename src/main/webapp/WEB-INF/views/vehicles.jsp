<%@ page import="java.util.List" %>
    <%@ page import="com.vehiclerental.model.Vehicle" %>
        ...
        <head>
            ...
            <title>Vehicle List — Intelligent Auto Rentals</title>
            <link
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size: 0.8rem; color: var(--muted); line-height: 1.4;">
                                            <% if (v.getDetails() !=null) { %>
                                                Fuel: <span style="color: var(--text)">
                                                    <%= v.getDetails().getFuelType() %>
                                                </span><br>
                                                Seats: <span style="color: var(--text)">
                                                    <%= v.getDetails().getSeatingCapacity() %>
                                                </span><br>
                                                AC: <span style="color: var(--text)">
                                                    <%= v.getDetails().isHasAc() ? "Yes" : "No" %>
                                                </span><br>
                                                Trans: <span style="color: var(--text)">
                                                    <%= v.getDetails().isHasGear() ? "Manual" : "Auto" %>
                                                </span>
                                                <% } else { %>
                                                    <span style="opacity: 0.5;">N/A</span>
                                                    <% } %>
                                        </td>
                                        <td class="td-price">LKR <%= v.getPricePerDay() %>
                                        </td>
                                        <td>
                                            <% if (v.isAvailable()) { %>
