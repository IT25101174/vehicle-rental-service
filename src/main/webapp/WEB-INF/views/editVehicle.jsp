...
<head>
    ...
    <title>Edit Vehicle — Intelligent Auto Rentals</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-save:hover { opacity: 0.86; transform: translateY(-1px); }
        ...
        .btn-cancel:hover { border-color: rgba(255,255,255,0.25); }
    ...
    <div class="card">
        ...
        <form action="../vehicle" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" id="brand" name="brand" value="<%= vehicle.getBrand() %>" required />
            </div>
