...
<head>
    ...
    <title>Customer Feedback — Intelligent Auto Rentals</title>
    ...
    <div class="container">
        <div class="header-section">
            ...
            <%
                ...
                if (vehicle != null) {
            %>
                <h1 class="page-title">Reviews for <%= vehicle.getBrand() %></h1>
                <p class="page-desc">Classified as <%= vehicle.getType() %> | Price rate: <%= vehicle.getPricePerDay() %> LKR/day</p>
            ...
            <div class="review-card">
                <div class="card-top">
                    <div class="user-info">
                        ...
                        <div>
                            <div class="user-name"><%= r.getUserName() %></div>
                            <div class="stars">
                                <%
                                    for (int i = 1; i <= 5; i++) {
                                        if (i <= r.getRating()) {
